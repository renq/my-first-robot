 ...
 */
const uint8_t LEFT_IN1 = A0;
const uint8_t LEFT_IN2 = A1;
...
/*
 * LEFT_ENC_A and RIGHT_ENC_A must be an INTERRUPT type (in UNO INT pins are 2 and 3).
 ...
 * Serial1 TX/RX pins
 */
const uint8_t JOYSTICK_WIRE_RX = 8;
const uint8_t JOYSTICK_WIRE_TX = 9;
